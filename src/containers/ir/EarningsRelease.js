...
class EarningsRelease extends React.Component {

    render(){
        const tableCol15per = {width: 15 + '%'}
        const tableCol55per = {width: 55 + '%'}
        ...
        return (
            <div>
                ...
                <div className="earnings_release">
                    <table className="basic_list">
                        <caption><span>공고 리스트</span></caption>
                        <colgroup>
                            <col style={tableCol15per} />
                            <col style={tableCol55per} />
                            <col style={tableCol15per} />
                            <col style={tableCol15per} />
                        </colgroup>
                        <thead>
                        <tr>
                            ...
                            <th scope="col">제목</th>
                            <th scope="col">날짜</th>
                            <th className="last" scope="col">첨부파일</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>1522</td>
                            <td className="subject"><a href="#">2011.11.12 이사회 IR 행사 01</a></td>
                            <td>2011.08.29</td>
                            <td className="file"><a href="#">PDF Down</a></td>
                        </tr>
                        </tbody>
                    </table>
...
export default EarningsRelease;